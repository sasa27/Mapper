...
public class MapperOptions {
	...
	public static void setOptions(String[] args) throws Exception {
	    ...
	    try {
		    ...
		    Main.reg = line.getOptionValue("reg");	 
		    Main.output = line.getOptionValue("output");
		    Main.extract = line.getOptionValue("extract");
		    
		    if(!Main.extract.equals("date") && !Main.extract.equals("id") && !Main.extract.equals("dateid") && !Main.extract.equals("iddate")) {
		    	throw new Exception();
		    }
	    	...
	    	System.out.println("Usage : Main -i <input> -r <regex> -o <output> -e <extract algo>\n"
	...
	private static Options configParameters() {
	    ...
	    final Option extractOption = Option.builder("e")
				.longOpt("extract")
				.desc("extract method to use")
				.hasArg(true)
				.argName("extract")
				.required(true)
				.build();
